	...
	<section>
		...
		<form action="managementboardinsert" id="frm" method="post">
			...
			<c:if test="${sessionLogin==null }"> 
				<input type="hidden" name="writer" id="writer" value="${sessionLogin }">
			</c:if>
			<c:if test="${sessionLogin!=null }">
...
<!-- 				<tr>
 ...
 -->				<tr>
				...
				<tr>
					<td colspan="2"><textarea rows="30" cols="70" name="content" id="content"></textarea></td>
				</tr>
				<tr align="center">
					<td colspan="2"><input type="submit" id="btn" value="등록"><input type="button" value="취소"></td>
				</tr>
			</table>
		</form>
		</div>
