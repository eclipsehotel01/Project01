...
<body>
	...
	<div id="main_content">
		<div id="total" align="center">
			<div align="right">총 게시물 수:${count }</div>
			<br>
			<br>
...
<h2><a href="logout">[로그아웃]</a></h2>
			...
			<table border=1>
				<tr>
					<th colspan="7"><a
						href="Managementboardregister?category=${category }">글쓰기</a></th>
				</tr>
				<tr>
					<th>no</th>
					<th>category</th>
 ...
 --%>
			...
			${pageHtml }
			<form method="get">
				<input type="hidden" id="category" value="${category }"> <select
					id="field" name="word">
					<option value="title">제목</option>
					<option value="id">작성자</option>
				</select> <input type="text" id="word" name="word"> <input
					type="button" id="searchBtn" value="검색" onclick="search()">
			</form>
		</div>
		<div id="results"></div>
