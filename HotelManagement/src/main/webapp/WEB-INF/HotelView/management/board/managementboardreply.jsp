	...
	<section>
		...
		<div id="main_content">
			<form action="boardReply1" id="frm">
				...
				<input type="text" id="b_num" name="b_num" value="${board.b_num }">
				<input type="text" id="groups" name="groups" value="${board.groups }">
				<input type="text" id="levels" name="levels" value="${board.levels }">
