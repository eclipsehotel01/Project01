	...
	<div id="main_content">
		...
		<div id="content_list">
			...
			<div id="content_list_table">
				<form action="room_insert" id="insert" enctype="multipart/form-data" method="post">
					<table class="tableStyle">
						...
						<tr>
							<th>이미지</th>
							<td style="padding-left:15px"><input type="file" id="img" name="img"> <span style="color: #f3662b;font-weight: bold">(*jpg형식)</span></td>
						</tr>
