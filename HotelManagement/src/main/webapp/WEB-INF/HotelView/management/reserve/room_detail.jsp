...
<!-- JS -->
<script type="text/javascript" src="resources/js/management_room.js"></script>
			...
			<div id="content_list_table">
				<form action="room_update" id="update">
					<table class="tableStyle">
						<tr>
							<th width="15%">객실호수</th>
							<td width="85%" style="padding-left: 15px"><input
								type="text" name="rnum" value="${infoDetail.rnum}">호</td>
						</tr>
						<tr>
							<th>객실면적</th>
							<td style="padding-left: 15px"><input type="text"
								name="rsize" value="${infoDetail.rsize}"> m</td>
						</tr>
						<tr>
							<th>객실유형</th>
							<td style="padding-left: 15px"><select id="rname"
								name="rname">
						...
						<tr>
							<th>침대유형</th>
							<td style="padding-left: 15px"><select id="rtype"
								name="rtype">
						...
						<tr>
							<th>기준인원</th>
							<td style="padding-left: 15px"><input type="text"
								name="standperson" value="${infoDetail.standperson}"> 명</td>
						</tr>
						<tr>
							<th>최대인원</th>
							<td style="padding-left: 15px"><input type="text"
								name="max_person" value="${infoDetail.max_person}"> 명</td>
						</tr>
						<tr>
							<th>요금정보</th>
							<td style="padding-left: 15px"><input type="text"
								name="price" value="${infoDetail.price}"> 타입</td>
						</tr>
						<tr>
							<th>설명</th>
							<td style="padding-left: 15px"><input type="text"
								name="memo" value="${infoDetail.memo}" size="80">
								<span style="color: #f3662b;font-weight: bold">(*40자 이내 작성)</span></td>
						</tr>
					</table>
