	...
	<div id="main">
		...
		<div id="main_content">
			...
			<div id="content_inner">
				<div class="login">					
					<div class="login-box">	
						<p class="t1">'The Eclipse Hotel'에 오신 것을 환영합니다. </p>				
						<table>
							<tr>
								<td>아이디</td>
								<td>
								...
								<td rowspan="2">
									<input type="button" value="로그인" onclick="btnLogin()" class="btn-login">
								</td>
							</tr>
							<tr>
								<td>비밀번호</td>
				...
				<div class="btn-area">
						<input type="button" value="가입신청" onclick="javascript:memberRegister();" class="btn-basic">										
				</div>
			</div>
			<!-- E : CONTENT INNER -->
